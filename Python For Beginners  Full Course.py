...
Name_1 = len(Name)  # Len Function For CHECKING THE LENGTH OF THE STRING.
...
Tupels = (1, 2, ("Arbaz", "Khan"), 3, 4, ("Good", (1, 2)))
print(Tupels[2])  # For Find The Position Of Tupels Word.
print(Tupels[5][1])  # For Find The Position Of Word In The Word.
...
print(Lists)
Lists.extend('ABCD')  # For Adding A New Line With Separate Words In The Lists.
print(Lists)
Lists_1 = ("A, B, C, D").split(",")  # For Separating The Words.
print(Lists+Lists_1)  # For Printing The Separated word And Lists Together.
